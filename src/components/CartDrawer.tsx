  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button variant="outline" size="icon" className="relative border-primary/50 text-primary hover:bg-primary/10">
      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col h-full bg-card border-primary/20">
        <SheetHeader className="flex-shrink-0">
          <SheetTitle className="text-neon-cyan">Carrinho de Compras</SheetTitle>
          <SheetDescription>
            ...
            <>
              <div className="flex-1 overflow-y-auto pr-2 min-h-0">
                <div className="space-y-4">
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-2 bg-background/50 rounded-lg border border-primary/10">
              ...
              <div className="flex-shrink-0 space-y-4 pt-4 border-t border-primary/20 bg-card">
                ...
                <Button
                  ...
                  className="w-full bg-accent hover:bg-accent/90 text-accent-foreground border-glow-cyan"
                  size="lg"
