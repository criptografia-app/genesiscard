...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = 'genesis-card-design-7rzua.myshopify.com';
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = '124bcb5c34f1ec432e4d51063fedf647';
